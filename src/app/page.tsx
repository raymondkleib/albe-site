          ...
          <div className="max-width">
            <div className="section-header">
              ...
              <p className="section-body">
                ...
                run late, some mornings come too fast. A normal alarm doesn&apos;t
                care. It drags you out of sleep at the exact worst moment, and
                you spend the day trying to fully &quot;boot up&quot; but never quite do.
              </p>
            </div>
            ...
            <div className="card-grid">
              <div className="card">
                ...
                <p className="card-body">
                  ...
                  deep sleep when it hits. If you are, your body panics and the
                  whole day starts on hard mode.
                </p>
              </div>
              <div className="card">
              ...
              <div className="card">
                ...
                <p className="card-body">
                  Either you get no feedback, or you get 50 graphs and no clear
                  change in how you actually feel in the morning.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="max-width">
            <div className="section-header">
              ...
              <p className="section-body">
                ...
                focused on one job: helping you wake up better and protect your
                rest.
              </p>
            </div>
            ...
            <div className="card-grid">
              <div className="card">
                ...
                <p className="card-body">
                  ...
                  moment to wake you—so you don&apos;t get ripped out of deep sleep.
                </p>
              </div>
              <div className="card">
                <div className="card-title">Gentle wrist vibration</div>
                <p className="card-body">
                  Instead of a phone screaming across the room, ALBE uses a calm
                  vibration on your wrist. Enough to wake you, not enough to
                  spike your stress.
                </p>
              </div>
              <div className="card">
              ...
              <div className="step">
                ...
                <div>
                  ...
                  <p className="step-content-body">
                    The band tracks heart rate and movement quietly through the
                    night. No screen, no buzzing, just data.
                  </p>
                </div>
              </div>
              <div className="step">
          ...
          <div className="max-width">
            ...
            <div className="comparison">
              ...
              <div className="comparison-block">
                ...
                <p className="section-body">
                  ALBE is built around one mission: help you wake up better and
                  protect your rest. Screenless, wearable all day, and priced
                  lower than most performance wearables.
                </p>
              </div>
            </div>
          </div>
            ...
            <div className="card-grid">
              <div className="card">
                ...
                <ul className="card-body" style={{ paddingLeft: '1.1rem' }}>
                  ...
                  <li>Founding price of <strong>$149</strong> (future $199)</li>
            ...
            <div className="founder">
              <div className="section-header">
                ...
                <p className="section-body">
                  ...
                  want another screen screaming at me. I wanted a calm, smart
                  band that actually changed how my mornings felt.
                </p>
                <p className="section-body">
                  ALBE started as sketches and sensor tests on my own wrist.
                  This first batch is for people just like me—students, workers,
                  lifters, anyone who needs better mornings without pretending
                  their sleep schedule is perfect.
                </p>
              </div>
                ...
                <div className="faq-grid">
                  <div className="faq-item">
                    ...
                    <div className="faq-a">
                      ...
                      updates. You can cancel for a full refund any time before
                      your band ships.
                    </div>
                  </div>
                  <div className="faq-item">
                    ...
                    <div className="faq-a">
                      No. ALBE is not a medical device and doesn&apos;t diagnose
                      any condition. It&apos;s built to help you wake up better
                      and understand your patterns, not replace your doctor.
                    </div>
                  </div>
                  <div className="faq-item">
                    ...
                    <div className="faq-a">
                      ...
                      features included. We may add subscription options later,
                      but you&apos;ll keep the features you pre-ordered with.
                    </div>
                  </div>
                  <div className="faq-item">
